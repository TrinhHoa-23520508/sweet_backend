...
public class DataInitializer implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                trangThaiRespo.saveAll(List.of(
                                new TrangThai(0L, 1, "Đã tất toán", loaiTrangThai),
                                new TrangThai(0L, 2, "Chưa tất toán", loaiTrangThai),
                                new TrangThai(0L, 3, "Thành công", loaiTrangThai),
                                new TrangThai(0L, 4, "Thất bại", loaiTrangThai),
                                new TrangThai(0L, 5, "Còn hoạt động", loaiTrangThai),
                                new TrangThai(0L, 6, "Đã hủy", loaiTrangThai)));
