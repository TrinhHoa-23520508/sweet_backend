...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        var vaiTros = vaiTroRepo.saveAll(List.of(
                new VaiTro(null, "KHONG_QUYEN_KHACH_HANG", true, "tài khoản không có quyền thực hiện điều gì", true,
                        // Cai tiep theo la list quyen han
                        List.of(), List.of(), List.of()),
                new VaiTro(null, "QUYEN_THANH_TOAN", true, "Chỉ có quyền thực hiện các giao dịch thanh toán", true,
                        quyenHanThanhToan, List.of(), List.of()),
                new VaiTro(null, "QUYEN_TIET_KIEM", true, "Có quyền thanh toán và thực hiện các chức năng tiết kiệm", true,
                        List.of(), List.of(), List.of()),
                new VaiTro(null, "QUAN_TRI_VIEN", false, "Có toàn quyền trong hệ thống", true,
                        quyenHans, List.of(), List.of()),
                new VaiTro(null, "KHONG_QUYEN_NHAN_VIEN", false, "Không có quyền truy cập vào hệ thống", true,
                        List.of(), List.of(), List.of()),
                new VaiTro(null, "NHAN_VIEN_GIAO_DICH", false, "Xử lý các giao dịch của khách hàng", true,
                        List.of(), List.of(), List.of()),
