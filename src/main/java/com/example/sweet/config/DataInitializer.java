...
// new LoaiGiaoDich(null, 3, "Gửi tiền vào phiếu gửi tiền", "Gửi tiền vào phiếu
// gửi tiền"),
// new LoaiGiaoDich(null, 4, "Rút tiền từ phiếu gửi tiền", "Rút tiền từ phiếu
// gửi tiền"),
// new LoaiGiaoDich(null, 5, "Tất toán phiếu gửi tiền", "Tất toán phiếu gửi
// tiền"),
// new LoaiGiaoDich(null, 6, "Trả tiền lãi", "Trả tiền lãi"),
// new LoaiGiaoDich(null, 7, "Đáo hạn phiếu gửi tiền", "Đáo hạn phiếu gửi
// tiền")));
...
// new LoaiTrangThai(null, "payment_account", "Tài khoản thanh toán", "Tài khoản
// thanh toán"),
// new LoaiTrangThai(null, "transaction", "Giao dịch", "Giao dịch"),
// new LoaiTrangThai(null, "deposit_receipt", "Phiếu gửi tiền", "Phiếu gửi
// tiền"),
// new LoaiTrangThai(null, "login_account", "Tài khoản đăng nhập", "Tài khoản
// đăng nhập")))
// .iterator();
...
// new TrangThai(null, "success", "Giao dịch thành công",
// loaiTrangThais.get(3)),
...
// var vaiTro = vaiTroRepo.save(new VaiTro(null, "Foo", "fOO", true,
// List.of()));
// var diaChi = diaChiRepo.save(new DiaChi(null, 1, "foo", "foo", "foo",
// "foo"));

// var admin = nhanVienRepository.save(
// new NhanVien(null, "123", LocalDate.now(), "fawfawfaw", "foo@bar.com",
// diaChi, diaChi, LocalDate.now(), "admin", "123456789", vaiTro,
// trangThais.get(2))
// );
